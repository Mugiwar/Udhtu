...
class Validator{
	...
	*/
		...
		$this->title		=	(!empty($regData['mu_last_name'])) ? $regData['mu_last_name'] : null;
		$this->section		=	(!empty($regData['mu_name'])) ? $regData['mu_name'] : null;		
		$this->subsection	=	(!empty($regData['mu_middle_name'])) ? $regData['mu_middle_name'] : null;
		$this->content 		=	(!empty($regData['mu_sex'])) ? $regData['mu_sex'] : null;
		$this->language 	=	(!empty($regData['mu_tel'])) ? $regData['mu_tel'] : null;		
