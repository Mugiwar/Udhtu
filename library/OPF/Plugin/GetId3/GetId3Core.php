 ...
 */
namespace OPF\Plugin\GetId3;

use OPF\Plugin\GetId3\Lib\Helper;
use OPF\Plugin\GetId3\Exception\DefaultException;
...
class GetId3Core
{
    ...
    public function __construct()
    {
        ...
        if (!class_exists('OPF\\Plugin\\GetId3\\Lib\\Helper')) {
            $this->addStartupError(str_replace('\\', DIRECTORY_SEPARATOR, 'OPF\\Plugin\\GetId3\\Lib\\Helper') . '.php is missing or corrupt');
        }
    ...
    public function analyze($filename)
    {
        try {
            ...
            foreach (array('id3v2' => 'id3v2', 'id3v1' => 'id3v1', 'apetag' => 'ape', 'lyrics3' => 'lyrics3') as $tag_name => $tag_key) {
                ...
                if ($this->$option_tag) {
                    try {
                        $tag_class = 'OPF\\Plugin\\GetId3\\Module\\Tag\\' . ucfirst($tag_name);
            ...
            $class_name = 'OPF\\Plugin\\GetId3\\Module\\' . Helper::toCamelCase($determined_format['group'], '-', true) . '\\' . ucfirst($determined_format['module']);
    ...
    public function GetFileFormat(&$filedata, $filename = '')
    {
        ...
        foreach ($GetFileFormatArray as $format_name => $info) {
            ...
            if (!empty($info['pattern'])
                ...
                $info['class'] = 'OPF\\Plugin\\GetId3\\Module\\' . Helper::toCamelCase($info['group'], '-', true) . '\\' . ucfirst($info['module']);
